...
void FullscreenPid::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->doNotTrustThisValueCurrWindowChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->fullscreenPidChanged((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 2: _t->isOnHomescreenChanged((*reinterpret_cast< const bool(*)>(_a[1]))); break;
...
// SIGNAL 0
void FullscreenPid::doNotTrustThisValueCurrWindowChanged(const QString & _t1)
{
...
// SIGNAL 1
void FullscreenPid::fullscreenPidChanged(const int & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void FullscreenPid::isOnHomescreenChanged(const bool & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
